...
if [ $(hostname) = 'benGreenLaptop' ]; then
  sed 's/size: 12/size: 9/' ./alacritty/alacritty.yml > ${HOME}/.config/alacritty/alacritty.yml;
else
  sed 's/size: 9/size: 12/' ./alacritty/alacritty.yml > ${HOME}/.config/alacritty/alacritty.yml;
fi
